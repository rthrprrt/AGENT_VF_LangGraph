...
def test_initialize_agent_settings_populates_defaults(tmp_path):
    ...
    initial_state = AgentState(
        ...
        # Laisser les autres champs à None pour qu'ils prennent les valeurs
        # de mock_settings_instance
        llm_model_name=None,
        embedding_model_name=None,
        recreate_vector_store=(AgentState.__fields__["recreate_vector_store"].default),
    ...
    # output_directory et vector_store_path sont fournis dans initial_state,
    # donc ils ne sont pas écrasés
    ...
    assert result["recreate_vector_store"] is False
...
def test_initialize_agent_settings_preserves_overrides(tmp_path):
    ...
    mock_settings_instance = Settings(
        ...
        # Cette valeur de settings sera ignorée car recreate_vector_store
        # est set dans initial_state
        recreate_vector_store=False,
        k_retrieval_count=5,
    )
    with patch("src.nodes.n0_initial_setup.settings", mock_settings_instance):
    ...
    assert result["recreate_vector_store"] is True
